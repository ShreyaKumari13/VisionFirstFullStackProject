...
const CreateAdminCompany = () => {
    ...
    const [createdByRole, setCreatedByRole] = useState("IT_ADMIN");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/api/company', newCompany);
...
export default CreateAdminCompany;
